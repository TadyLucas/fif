    ...
    <>
      ...
      <section id="Home">
        ...
        <div id="toCenter" className="on-Bottom">
          ...
          <br />
          <span>
            Vytvořený partou ajťáků a jednou skvělou paní učitelkou 💻
          </span>
        </div>
      </section>
      <section id="About">
        <div>
          ...
          <div>
            ...
            <p>
              ...
              dignissimos eligendi. Dolores magnam veniam architecto iusto,
              quisquam nam, expedita, quaerat voluptatibus asperiores ipsa
              itaque deleniti rem eveniet aperiam molestiae excepturi?
            </p>
          </div>
        </div>
      </section>
